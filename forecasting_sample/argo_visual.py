...
folder_path = '/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993/'
#lidar_data path (The directory until you see lots of log folders)
lidar_path = '/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993'
result_dirs = [d for d in os.listdir(folder_path) if os.path.isdir(os.path.join(folder_path, d))]

while not rospy.is_shutdown():
    for dirs in result_dirs:
        ids = []
        for filename in sorted(os.listdir('/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993/per_sweep_annotations_amodal/')):          
            resultsf = open('/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993/per_sweep_annotations_amodal/' + filename, 'r')
            ...
            for lidar in sorted(os.listdir('/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993/lidar/')):
                if str(tstamp) in lidar:
                    try:
                        plydata = PlyData.read('/home/anny/argo_sample/argoverse-tracking/sample/c6911883-1843-3727-8eaa-41dc8cda8993/lidar/' + lidar)
